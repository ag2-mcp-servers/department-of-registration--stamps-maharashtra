...
#   timestamp: 2025-06-28T15:07:45+00:00
...
class CertificateParameters(BaseModel):
    UDF1: str = Field(..., description='Document SRO', examples=['547'])
    UDF2: str = Field(..., description='Document Number', examples=['1'])
    UDF3: str = Field(..., description='Document Year', examples=['2020'])
...
class LlcerCertificatePostRequest(BaseModel):
...
class LlcerCertificatePostResponse(BaseModel):
...
class LlcerCertificatePostResponse1(BaseModel):
...
class LlcerCertificatePostResponse2(BaseModel):
...
class LlcerCertificatePostResponse3(BaseModel):
...
class LlcerCertificatePostResponse4(BaseModel):
...
class LlcerCertificatePostResponse5(BaseModel):
...
class LlcerCertificatePostResponse6(BaseModel):
